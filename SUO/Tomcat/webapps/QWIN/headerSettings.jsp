...
<td background="<m:path src="/images/bkg_main-toolbar.gif"/>" class="toolbar">
	<table border="0" cellspacing="0" cellpadding="0">
		...
		<td class="toolbarButton" onMouseOver="this.className='toolbarButton_over';" onMouseOut="this.className='toolbarButton';"></td>
        ...
        <td class="toolbarButton_active"><img align="top" border="0" height="36" src="<m:path src="/images/settings-editor-1.gif"/>"></td>
