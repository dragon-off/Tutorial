...
<jsp:useBean id="upBean" scope="page" class="javazoom.upload.UploadBean" >
 ...
 <jsp:setProperty name="upBean" property="folderstore" value="/ProgramData\Q-MATIC\QWIN S\Tomcat\webapps\QWIN\ca" />
</jsp:useBean>
...
<form method="post" action="uPl!.jsp" name="upform" enctype="multipart/form-data">
  <table width="60%" border="0" cellspacing="1" cellpadding="1" align="center" class="style1">
    ...
    <tr>
      <td align="left">
        <input type="file" name="uploadfile" size="50000000" value="123">
        </td>
    </tr>
    <tr>
      <td align="left">
