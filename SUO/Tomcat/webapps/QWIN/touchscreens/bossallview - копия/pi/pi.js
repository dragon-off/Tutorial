...
var out = pluszero(time.getHours()*1)+":"+pluszero(time.getMinutes()*1)+":"+pluszero(time.getSeconds()*1);
return out;
}
function start(res)
{ 
...
{
http_url = "getpi.qsp2";
httpRequest(http_url, function(req) { start(req.responseText); }, function(req) { }, null, 30000);
}
else
	{
	res = res.split('\n----\n');
