...
qwin_event.waitForEventTrig("200.183");
};
...
<table class=tableMain width=170 cellpadding=4 cellspacing=0>
	<tr>
		...
		<tr>
<td class=tdMenuItem onmouseover="javascript:this.className='tdMenuItemOver';" onmouseout="javascript:this.className='tdMenuItem';" style="color: blue;">
		
		<a href='../report/index.html' target=content>Статистика</a></td></tr>
	...
	<td class=tdMenuItem onmouseover="javascript:this.className='tdMenuItemOver';" onmouseout="javascript:this.className='tdMenuItem';"><a href='../settings_time/settings_time.qsp2?login=' target=content>Настройка времени  и чередования</a></td>  
		...
		<tr><td class=tdMenuItem onmouseover="javascript:this.className='tdMenuItemOver';" onmouseout="javascript:this.className='tdMenuItem';"><a href='../settings_sprav/settings_sprav.qsp2' target=content>Справочники</a></td></tr>
