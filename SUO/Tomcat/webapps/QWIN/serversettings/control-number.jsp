...
<tr>
  ...
  <td width="300" class="<ww:if test="@e == true">tdRightError</ww:if><ww:else>tdRight</ww:else>">
    <input class="input" <ww:if test="@field/isActive == false"> disabled </ww:if> id="<ww:property value="name"/>" onChange="setHasChanged(true);" size="5" type="text" value="<ww:property value="value"/>" name="<ww:property value="name"/>">
  </td>
</tr>
