...
<%
	...
	BufferedReader input = null;
     ...
     String fileName= "C:/ProgramData/Q-MATIC/QWIN S/Tomcat/webapps/QWIN/serversettings/reset/events.sql";
      ...
      try {
		...
		String sql="delete from events where convert(varchar(10), Happened, 104)=convert(varchar(10), GETDATE(),104)";
