...
<tr><td colspan="2" class="tdLabel"><ww:property value="@field/label"/></td></tr>
<tr>
    <td colspan="2" style="padding-left: 0px;">
        <div id="<ww:property value="name"/>_FRAME"  style="padding: 5px;">
            <textarea
                   ...
                   style="height: 40px; width: 450px;" name="<ww:property value="name"/>" id="<ww:property value="name"/>" onFocus="showTerminalScriptPanel('<ww:property value="name"/>',true);"><ww:property value="value"/></textarea><br>
            <div style="position: absolute; margin-bottom: 10px; margin-right:0px;margin-left:0px; margin-top:0px; padding:5px; visibility: hidden; width: 450px;" id="<ww:property value="name"/>_PANEL">
                <%--<select name="<ww:property value="name"/>_functions">
                ...
                <input value="Done" type="button" onClick="showTerminalScriptPanel('<ww:property value="name"/>',false);">
            </div>
        </div>
    </td>
</tr>
